...
void OLED_WR_Byte(u8 dat,u8 mode)
{
	uint8_t dat_ = dat;
	if(mode){	
    HAL_I2C_Mem_Write(&hi2c1, 0x78, 0x40, I2C_MEMADD_SIZE_8BIT, &dat_, 1,20);
	}
  else{
    HAL_I2C_Mem_Write(&hi2c1, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, &dat_, 1,20);
  }
}
